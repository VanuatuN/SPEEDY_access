...
C
     ...
     &     'Q0         0  99  near-surface specific humidity    [g/kg]',
     ...
     &     'SSRD       0  99  surface SW rad. (downward-only)[W/m^2]',
     &     'SLRD       0  99  surface LW rad. (downward-only)[W/m^2]',
     &     'SNOW       0  99  total (conv+large scale)      [mm/day]'/
!    &      1*' '/
C    SSRD, SLRD and SNOW - added for ACCESOM2 forcing: Natalia 03/09/2026
